...
export const alphabetData: AlphabetEntry[] = [
  ...
  { letter: "B", word: "Bear", emoji: "🐻", color: "#A0522D" },
  ...
  { letter: "I", word: "Iguana", emoji: "🦎", color: "#16A085" },
  ...
  { letter: "O", word: "Octopus", emoji: "🐙", color: "#9B59B6" },
  { letter: "P", word: "Panda", emoji: "🐼", color: "#3C4858" },
