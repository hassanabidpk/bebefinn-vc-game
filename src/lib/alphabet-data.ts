...
export const alphabetData: AlphabetEntry[] = [
  ...
  },
  {
    ...
    emoji: "🐘",
    color: "#95A5A6",
    variants: [{ letter: "E", word: "Eagle", emoji: "🦅", color: "#34495E" }],
  },
  {
    letter: "F",
    word: "Fish",
  ...
  },
  {
    ...
    emoji: "🦍",
    color: "#8854D0",
    variants: [{ letter: "G", word: "Giraffe", emoji: "🦒", color: "#F4B350" }],
  },
  {
    letter: "H",
    word: "Hippo",
    emoji: "🦛",
    color: "#7F8C8D",
    variants: [{ letter: "H", word: "Horse", emoji: "🐴", color: "#8E5A35" }],
  },
  {
    letter: "I",
    word: "Ice Cream",
    emoji: "🍦",
    color: "#FFEAA7",
    variants: [{ letter: "I", word: "Iguana", emoji: "🦎", color: "#2ECC71" }],
  },
  ...
  { letter: "L", word: "Lion", emoji: "🦁", color: "#F39C12" },
  {
    ...
    emoji: "👩",
    color: "#F1C40F",
    variants: [{ letter: "M", word: "Monkey", emoji: "🐵", color: "#A0522D" }],
  },
  {
    letter: "N",
    word: "Nest",
    emoji: "🪺",
    color: "#8B4513",
    variants: [{ letter: "N", word: "Narwhal", emoji: "🐋", color: "#54A0FF" }],
  },
  {
    letter: "O",
    word: "Octopus",
  ...
  { letter: "T", word: "Turtle", emoji: "🐢", color: "#27AE60" },
  {
    ...
    emoji: "🦄",
    color: "#A569BD",
    variants: [{ letter: "U", word: "Urchin", emoji: "🪸", color: "#8E44AD" }],
  },
