...
export const ANIMAL_INFO: Record<string, AnimalInfo> = {
  ...
  Giraffe: { en: "Giraffes have long necks!", zh: "长颈鹿脖子长！", pinyin: "Cháng jǐng lù bó zi cháng" },
  ...
  Horse: { en: "Horses run fast!", zh: "小马跑得快！", pinyin: "Xiǎo mǎ pǎo de kuài" },
  ...
  Monkey: { en: "Monkeys swing on trees!", zh: "猴子树上荡！", pinyin: "Hóu zi shù shàng dàng" },
  Narwhal: { en: "Narwhals have long tusks!", zh: "独角鲸有长牙！", pinyin: "Dú jiǎo jīng yǒu cháng yá" },
  ...
  Urchin: { en: "Urchins have spiky shells!", zh: "海胆刺刺的！", pinyin: "Hǎi dǎn cì cì de" },
