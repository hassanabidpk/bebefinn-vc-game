...
export const DRAW_ANIMALS: DrawAnimal[] = [
  ...
  },
  {
    ...
    steps: [
      {
        paths: ["M 132 286 C 132 218 202 178 292 190 C 370 200 414 248 398 310 C 382 370 310 392 226 374 C 164 362 132 330 132 286 Z"],
        say: "Draw a long round body!",
      },
      {
        paths: [
          "M 76 246 C 94 204 142 190 176 214 C 194 228 196 260 178 282 C 148 306 98 290 76 258 Z",
          "M 76 246 C 56 248 44 260 48 274 C 62 286 80 282 94 270",
        ],
        say: "Add a head and snout!",
      },
      {
        paths: [
          "M 174 352 C 154 380 148 410 166 434 L 204 434",
          "M 310 382 C 302 408 314 432 344 438 L 374 438",
          "M 398 310 C 438 330 462 356 470 390 C 446 376 424 358 402 338",
        ],
        say: "Two feet and a curly tail!",
      },
      {
        paths: [
          "M 166 202 L 182 166 L 202 194 L 224 150 L 244 190 L 270 144 L 290 190 L 316 154 L 334 204",
        ],
        say: "Add zigzag spikes on top!",
        detail: true,
      },
      {
        paths: [
          "M 232 252 A 12 8 0 1 1 256 252 A 12 8 0 1 1 232 252",
          "M 292 286 A 14 9 0 1 1 320 286 A 14 9 0 1 1 292 286",
          "M 214 322 A 10 7 0 1 1 234 322 A 10 7 0 1 1 214 322",
        ],
        say: "Dot some scales on the back!",
        detail: true,
      },
      {
        paths: [
          "M 104 238 A 12 12 0 1 1 128 238 A 12 12 0 1 1 104 238",
          "M 58 266 A 7 7 0 1 1 72 266 A 7 7 0 1 1 58 266",
          "M 94 270 Q 122 286 150 270",
        ],
        say: "Draw one eye and a smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 126 244 C 126 144 184 88 256 88 C 328 88 386 144 386 244 C 330 274 182 274 126 244 Z"],
        say: "Draw a big jelly bell!",
      },
      {
        paths: [
          "M 160 254 C 132 304 180 334 150 390 C 134 420 150 442 176 454",
          "M 224 264 C 196 310 242 344 214 398 C 202 422 214 444 236 458",
          "M 288 264 C 316 310 270 344 298 398 C 310 422 298 444 276 458",
          "M 352 254 C 380 304 332 334 362 390 C 378 420 362 442 336 454",
        ],
        say: "Add four wavy tentacles!",
      },
      {
        paths: [
          "M 174 176 A 14 14 0 1 1 202 176 A 14 14 0 1 1 174 176",
          "M 310 154 A 10 10 0 1 1 330 154 A 10 10 0 1 1 310 154",
          "M 264 212 A 12 12 0 1 1 288 212 A 12 12 0 1 1 264 212",
        ],
        say: "Decorate the bell with spots!",
        detail: true,
      },
      {
        paths: [
          "M 406 156 A 13 13 0 1 1 432 156 A 13 13 0 1 1 406 156",
          "M 438 112 A 8 8 0 1 1 454 112 A 8 8 0 1 1 438 112",
        ],
        say: "Float two bubbles nearby!",
        detail: true,
      },
      {
        paths: [
          "M 196 206 A 13 13 0 1 1 222 206 A 13 13 0 1 1 196 206",
          "M 290 206 A 13 13 0 1 1 316 206 A 13 13 0 1 1 290 206",
          "M 216 226 Q 256 250 296 226",
        ],
        say: "Two eyes and a wavy smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 178 324 C 176 244 214 196 272 206 C 334 216 366 292 348 370 C 330 430 252 446 206 402 C 188 382 180 352 178 324 Z"],
        say: "Draw a tall bouncy body!",
      },
      {
        paths: [
          "M 202 190 C 190 140 220 108 264 114 C 306 120 326 160 308 198 C 288 228 228 224 202 190 Z",
          "M 300 150 C 338 146 362 158 374 180 C 350 192 326 194 306 188",
          "M 216 122 C 196 82 202 52 220 44 C 238 66 244 90 240 118",
          "M 270 116 C 270 74 286 48 306 48 C 316 78 308 102 298 126",
        ],
        say: "Add a head and tall ears!",
      },
      {
        paths: [
          "M 214 386 C 178 408 152 436 134 466 L 212 466",
          "M 308 408 C 334 432 358 450 390 460 L 426 458",
          "M 184 352 C 126 350 80 374 50 414 C 104 400 150 388 198 374",
        ],
        say: "Big feet and a balancing tail!",
      },
      {
        paths: [
          "M 212 270 C 178 286 164 318 178 346 C 198 358 218 344 224 320",
          "M 316 276 C 346 298 354 326 342 350 C 324 356 308 340 304 318",
        ],
        say: "Add two little front paws!",
        detail: true,
      },
      {
        paths: ["M 230 326 Q 264 348 306 324 Q 300 378 266 388 Q 232 376 230 326 Z"],
        say: "Draw a cozy tummy pouch!",
        detail: true,
      },
      {
        paths: [
          "M 232 166 A 11 11 0 1 1 254 166 A 11 11 0 1 1 232 166",
          "M 290 164 A 11 11 0 1 1 312 164 A 11 11 0 1 1 290 164",
          "M 350 174 A 7 7 0 1 1 364 174 A 7 7 0 1 1 350 174",
          "M 250 190 Q 276 208 304 188",
        ],
        say: "Eyes, nose, and a happy smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 92 286 C 94 212 168 170 272 180 C 358 190 410 236 400 298 C 388 362 306 390 210 374 C 134 362 88 330 92 286 Z"],
        say: "Draw a smooth whale body!",
      },
      {
        paths: [
          "M 400 266 C 428 226 452 204 474 190 C 464 228 452 258 434 282 C 454 306 468 334 474 370 C 446 350 424 326 400 298",
          "M 264 370 C 276 406 304 428 338 436 C 324 404 304 382 284 374",
        ],
        say: "Add tail fins and a flipper!",
      },
      {
        paths: [
          "M 132 198 L 74 74 L 174 186 Z",
          "M 94 116 L 128 104",
          "M 108 146 L 144 132",
        ],
        say: "Draw one long twisty horn!",
      },
      {
        paths: [
          "M 292 236 A 14 10 0 1 1 320 236 A 14 10 0 1 1 292 236",
          "M 334 286 A 12 8 0 1 1 358 286 A 12 8 0 1 1 334 286",
          "M 244 316 A 10 7 0 1 1 264 316 A 10 7 0 1 1 244 316",
        ],
        say: "Dot three spots on its back!",
        detail: true,
      },
      {
        paths: [
          "M 164 174 C 150 144 158 118 176 98",
          "M 176 174 C 184 142 202 120 226 106",
        ],
        say: "Splash water over the horn!",
        detail: true,
      },
      {
        paths: [
          "M 146 250 A 13 13 0 1 1 172 250 A 13 13 0 1 1 146 250",
          "M 112 296 Q 150 324 192 300",
        ],
        say: "One eye and a big smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 158 328 A 104 96 0 1 1 366 328 A 104 96 0 1 1 158 328"],
        say: "Draw a cuddly round body!",
      },
      {
        paths: [
          "M 178 210 A 82 76 0 1 1 342 210 A 82 76 0 1 1 178 210",
          "M 170 156 A 38 38 0 1 1 246 156 A 38 38 0 1 1 170 156",
          "M 278 156 A 38 38 0 1 1 354 156 A 38 38 0 1 1 278 156",
        ],
        say: "Add a head and round ears!",
      },
      {
        paths: [
          "M 184 306 C 146 328 144 362 170 382",
          "M 340 306 C 378 328 380 362 354 382",
          "M 188 402 A 34 20 0 1 1 256 402 A 34 20 0 1 1 188 402",
          "M 272 402 A 34 20 0 1 1 340 402 A 34 20 0 1 1 272 402",
        ],
        say: "Little arms and two big feet!",
      },
      {
        paths: ["M 358 338 C 420 344 452 376 438 418 C 420 440 390 424 382 398"],
        say: "Curl a thick tail behind!",
        detail: true,
      },
      {
        paths: ["M 220 310 C 246 292 282 292 308 310 C 304 354 284 382 264 386 C 240 380 222 352 220 310 Z"],
        say: "Add a soft tummy patch!",
        detail: true,
      },
      {
        paths: [
          "M 214 210 A 12 12 0 1 1 238 210 A 12 12 0 1 1 214 210",
          "M 286 210 A 12 12 0 1 1 310 210 A 12 12 0 1 1 286 210",
          "M 250 238 A 10 8 0 1 1 270 238 A 10 8 0 1 1 250 238",
          "M 220 254 Q 260 292 302 254",
        ],
        say: "Make its famous happy smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 156 278 A 100 100 0 1 1 356 278 A 100 100 0 1 1 156 278"],
        say: "Draw a round urchin body!",
      },
      {
        paths: [
          "M 176 214 L 112 170 M 202 190 L 172 112 M 238 178 L 230 82 M 274 178 L 292 82 M 310 190 L 354 110",
          "M 336 214 L 410 164 M 352 252 L 446 232 M 352 296 L 446 320 M 330 338 L 398 396",
          "M 292 368 L 322 452 M 248 378 L 242 466 M 208 366 L 170 448 M 174 338 L 108 398",
          "M 158 296 L 66 320 M 160 252 L 68 226 M 184 208 L 124 148",
        ],
        say: "Add lots of pointy spikes!",
      },
      {
        paths: [
          "M 206 246 A 10 10 0 1 1 226 246 A 10 10 0 1 1 206 246",
          "M 286 224 A 8 8 0 1 1 302 224 A 8 8 0 1 1 286 224",
          "M 304 302 A 11 11 0 1 1 326 302 A 11 11 0 1 1 304 302",
        ],
        say: "Dot tiny bumps on its shell!",
        detail: true,
      },
      {
        paths: [
          "M 408 96 A 12 12 0 1 1 432 96 A 12 12 0 1 1 408 96",
          "M 440 62 A 7 7 0 1 1 454 62 A 7 7 0 1 1 440 62",
        ],
        say: "Float two bubbles overhead!",
        detail: true,
      },
      {
        paths: [
          "M 202 270 A 13 13 0 1 1 228 270 A 13 13 0 1 1 202 270",
          "M 282 270 A 13 13 0 1 1 308 270 A 13 13 0 1 1 282 270",
          "M 218 308 Q 256 334 294 308",
        ],
        say: "Two eyes and a tiny smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 164 320 C 164 232 208 184 270 190 C 338 196 374 268 354 364 C 338 426 242 442 190 394 C 172 376 164 348 164 320 Z"],
        say: "Draw a big feathered body!",
      },
      {
        paths: [
          "M 186 190 C 174 138 206 102 252 108 C 286 114 300 144 286 176 C 270 204 218 214 186 190 Z",
          "M 184 160 L 108 182 L 184 194 Z",
        ],
        say: "Add a bald head and beak!",
      },
      {
        paths: [
          "M 188 246 C 122 252 76 300 64 364 C 116 342 158 322 198 286",
          "M 340 244 C 406 252 448 300 456 366 C 408 342 370 316 330 284",
        ],
        say: "Stretch two giant wings!",
      },
      {
        paths: [
          "M 224 410 L 212 456 M 202 456 L 184 470 M 212 456 L 212 474 M 220 456 L 238 470",
          "M 302 414 L 314 458 M 304 458 L 288 472 M 314 458 L 316 474 M 324 458 L 342 470",
        ],
        say: "Add two clawed bird feet!",
        detail: true,
      },
      {
        paths: ["M 190 204 C 214 228 260 230 290 198", "M 202 216 C 224 242 262 244 282 216"],
        say: "Ruffle feathers around the neck!",
        detail: true,
      },
      {
        paths: [
          "M 214 150 A 12 12 0 1 1 238 150 A 12 12 0 1 1 214 150",
          "M 122 180 A 7 7 0 1 1 136 180 A 7 7 0 1 1 122 180",
          "M 204 178 Q 230 192 254 176",
        ],
        say: "One eye and a friendly grin!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 76 270 C 122 196 230 170 342 206 C 376 218 398 240 414 270 C 386 318 312 350 218 344 C 148 340 100 314 76 270 Z"],
        say: "Draw a see-through fish body!",
      },
      {
        paths: [
          "M 414 250 L 472 192 L 458 270 L 472 350 L 414 290 Z",
          "M 230 188 C 252 140 284 114 320 104 C 316 146 306 174 290 194",
          "M 230 338 C 256 378 292 396 328 400 C 312 366 294 344 274 336",
        ],
        say: "Add a tail and two fins!",
      },
      {
        paths: [
          "M 174 230 L 174 310 M 198 220 L 198 320 M 222 214 L 222 326 M 246 212 L 246 328 M 270 214 L 270 326 M 294 220 L 294 318 M 318 228 L 318 308",
          "M 152 270 C 206 244 282 244 340 270 C 282 296 206 296 152 270",
        ],
        say: "Draw its funny see-through bones!",
      },
      {
        paths: [
          "M 354 174 A 12 12 0 1 1 378 174 A 12 12 0 1 1 354 174",
          "M 390 130 A 8 8 0 1 1 406 130 A 8 8 0 1 1 390 130",
        ],
        say: "Add two floating bubbles!",
        detail: true,
      },
      {
        paths: ["M 356 246 C 372 254 382 264 388 278", "M 350 294 C 366 286 378 280 390 278"],
        say: "Mark shiny lines near the tail!",
        detail: true,
      },
      {
        paths: [
          "M 104 254 A 13 13 0 1 1 130 254 A 13 13 0 1 1 104 254",
          "M 78 286 Q 112 310 148 292",
        ],
        say: "One eye and a fishy smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 108 298 C 110 216 184 182 286 192 C 374 202 414 254 398 326 C 384 390 306 414 210 398 C 142 386 106 348 108 298 Z"],
        say: "Draw a shaggy wide body!",
      },
      {
        paths: [
          "M 104 206 C 112 154 166 128 214 148 C 250 164 258 208 232 242 C 200 270 128 258 104 218 Z",
          "M 116 166 C 80 126 54 126 42 152 C 70 160 94 176 110 194",
          "M 206 156 C 244 120 274 126 288 154 C 258 158 236 174 222 194",
        ],
        say: "Add a head and curved horns!",
      },
      {
        paths: [
          "M 154 376 L 148 452 L 188 452 L 194 390",
          "M 318 400 L 326 456 L 366 456 L 358 378",
          "M 398 292 C 438 304 458 330 462 366 C 446 350 430 340 410 334",
        ],
        say: "Two legs and a swishy tail!",
      },
      {
        paths: [
          "M 132 244 L 146 274 L 160 248 L 176 282 L 192 252 L 208 282 L 224 246",
          "M 138 350 L 154 380 L 172 352 L 190 388 L 210 358 L 230 394 L 250 362 L 272 398 L 294 362 L 318 390 L 338 354 L 360 378",
        ],
        say: "Make its coat long and shaggy!",
        detail: true,
      },
      {
        paths: ["M 262 230 C 304 212 350 218 378 246", "M 270 248 C 310 232 348 238 372 260"],
        say: "Add two wavy back hairs!",
        detail: true,
      },
      {
        paths: [
          "M 132 198 A 12 12 0 1 1 156 198 A 12 12 0 1 1 132 198",
          "M 190 198 A 12 12 0 1 1 214 198 A 12 12 0 1 1 190 198",
          "M 154 226 A 8 7 0 1 1 170 226 A 8 7 0 1 1 154 226",
          "M 180 226 A 8 7 0 1 1 196 226 A 8 7 0 1 1 180 226",
          "M 150 238 Q 174 254 202 238",
        ],
        say: "Eyes, nose, and a warm smile!",
      },
    ],
  },
  {
    ...
    steps: [
      {
        paths: ["M 120 296 C 120 226 180 190 282 194 C 374 198 416 246 402 320 C 390 382 310 408 214 394 C 150 384 118 348 120 296 Z"],
        say: "Draw a sturdy striped body!",
      },
      {
        paths: [
          "M 116 220 C 90 178 112 136 158 126 C 202 120 232 152 222 194 C 214 232 150 252 116 220 Z",
          "M 124 138 L 108 82 L 150 122",
          "M 180 126 L 194 76 L 206 142",
        ],
        say: "Add a head and pointy ears!",
      },
      {
        paths: [
          "M 158 374 L 154 456 L 190 456 L 198 390",
          "M 326 396 L 334 458 L 372 458 L 366 370",
          "M 402 274 C 446 284 464 314 456 350 C 442 336 426 326 408 320",
          "M 246 198 L 278 388 M 302 202 L 330 392 M 350 218 L 374 366",
        ],
        say: "Two legs and a thin tail!",
      },
      {
        paths: [
          "M 158 202 L 182 242 M 188 190 L 212 230 M 226 200 L 246 242",
          "M 266 198 L 294 390 M 324 208 L 350 382 M 372 238 L 390 340",
          "M 150 392 L 178 420 M 334 410 L 366 430",
        ],
        say: "Paint lots of zigzag stripes!",
        detail: true,
      },
      {
        paths: ["M 210 144 L 236 126 L 250 154 L 272 134 L 286 162 L 310 146"],
        say: "Add a short spiky mane!",
        detail: true,
      },
      {
        paths: [
          "M 132 184 A 12 12 0 1 1 156 184 A 12 12 0 1 1 132 184",
          "M 190 182 A 12 12 0 1 1 214 182 A 12 12 0 1 1 190 182",
          "M 124 218 A 8 7 0 1 1 140 218 A 8 7 0 1 1 124 218",
          "M 150 218 A 8 7 0 1 1 166 218 A 8 7 0 1 1 150 218",
          "M 132 230 Q 158 248 188 228",
        ],
        say: "Eyes, nose, and a zebra smile!",
      },
    ],
  },
];
