...
// Realistic Veo 3.1 clips, played on demand when the user taps the video
// icon in a lesson. Map auto-generated by scripts/generate-videos.ts /
// upload-videos-blob.ts. Words with multiple variant clips get a random
// pick per call, so repeat views stay fresh.
export function getAnimalVideo(word: string): string | undefined {
  const entry = ANIMAL_VIDEOS[word];
