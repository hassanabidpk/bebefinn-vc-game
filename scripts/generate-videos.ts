...
const APPROVED_PROMPTS: Record<string, string> = {
  ...
  Crow:
    'Medium close-up of one friendly glossy black crow perched on a sunlit tree branch, tilting its head curiously and giving two gentle caws before opening its wings. Slow push-in, 50mm lens, warm soft morning light. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject, curious and friendly not scary. Audio: a warm friendly female narrator says cheerfully, "Crows say caw!" — no background music, natural gentle forest ambience and two soft crow caws only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Deer:
    'Wide-to-medium shot of one gentle young deer stepping through a bright green forest clearing, then making one graceful little leap and looking curiously toward the camera. Smooth low tracking camera, 50mm lens, warm dappled daylight. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject, sweet and calm. Audio: a warm friendly female narrator says cheerfully, "Deer leap through forests!" — no background music, natural gentle forest ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Dog:
  ...
  Eagle:
    'Wide-to-medium shot of a friendly eagle soaring smoothly across a bright blue sky above green mountains, wings spread clearly. Slow tracking camera, 50mm lens, sunny soft daylight. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject, majestic not scary. Audio: a warm friendly female narrator says clearly and cheerfully, "E is for Eagle!" — no background music, natural gentle wind ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Elephant:
  ...
  Giraffe:
    'Medium shot of a gentle giraffe stretching its long neck to nibble leaves from a tree in a sunny savanna. Slow push-in, 50mm lens, warm soft daylight. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject. Audio: a warm friendly female narrator says cheerfully, "Giraffes have long necks!" — no background music, natural ambient sound only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Gorilla:
  ...
  Horse:
    'Medium shot of a friendly horse trotting happily across a sunny green pasture, mane moving gently in the breeze. Slow side tracking camera, 50mm lens, warm soft daylight. Photorealistic farm documentary for young children, vibrant and clean, single clear subject. Audio: a warm friendly female narrator says cheerfully, "Horses run fast!" — no background music, natural ambient sound only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  "Ice Cream":
  ...
  Iguana:
    'Medium close-up of a bright green iguana climbing slowly on a sunny tree branch, blinking calmly. Slow low push-in, macro lens, warm daylight. Photorealistic nature documentary for young children, vibrant and clean, single clear subject, friendly not scary. Audio: a warm friendly female narrator says cheerfully, "Iguanas climb trees!" — no background music, natural ambient sound only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Jellyfish:
  ...
  Monkey:
    'Medium shot of a playful monkey swinging gently from a tree branch in a bright green jungle, smiling and pausing to look at the camera. Slow tracking camera, 50mm lens, soft daylight. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject. Audio: a warm friendly female narrator says cheerfully, "Monkeys swing on trees!" — no background music, natural ambient sound only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Narwhal:
    'Wide-to-medium shot of a friendly narwhal swimming slowly through clear blue arctic water, its long tusk visible and sparkling in soft light. Slow underwater tracking camera, 35mm lens, clean bright ocean scene. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject. Audio: a warm friendly female narrator says cheerfully, "Narwhals have long tusks!" — no background music, natural gentle water sounds only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Nest:
  ...
  Urchin:
    'Close-up of a colorful sea urchin resting on a bright coral reef, tiny spines moving gently in clear blue water. Slow macro push-in, soft ocean light, vibrant and clean, single clear subject. Photorealistic nature documentary for young children, friendly and not scary. Audio: a warm friendly female narrator says cheerfully, "Urchins have spiky shells!" — no background music, natural gentle water sounds only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Vulture:
  ...
  "4":
    'Medium shot of four friendly toy horses standing side by side in a bright preschool counting scene, each horse a different cheerful color and clearly separated so toddlers can count them. Slow push-in, soft warm daylight, colorful educational 3D-animation look, exactly four horses, no extra animals or objects. Audio: a warm friendly female narrator says cheerfully, "Four horses!" — no background music, natural gentle room ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  "5":
  ...
  "7":
    'Medium shot of seven bright yellow bananas arranged in a neat counting row on a clean pastel table, each banana clearly separated and easy for toddlers to count. Slow push-in, soft warm daylight, colorful educational 3D-animation look, exactly seven bananas, no extra fruit or objects. Audio: a warm friendly female narrator says cheerfully, "Seven bananas!" — no background music, natural gentle room ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  "8":
    'Top-down medium shot of exactly eight bright red strawberries on a clean pastel table, arranged in two neat rows of four with empty space between every strawberry so toddlers can count them easily. Slow gentle push-in, soft warm daylight, colorful educational 3D-animation look, only eight strawberries and no other objects. Audio: a warm friendly female narrator says cheerfully, "Eight strawberries!" — no background music, natural gentle room ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people, no letters, no digits, no symbols. 8 seconds, 16:9.',
  "9":
  ...
  "10":
    'Top-down medium shot of exactly ten bright yellow bananas on a clean pastel table, arranged in two neat rows of five with empty space between every banana so toddlers can count them easily. Slow gentle push-in, soft warm daylight, colorful educational 3D-animation look, only ten bananas and no other objects. Audio: a warm friendly female narrator says cheerfully, "Ten bananas!" — no background music, natural gentle room ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people, no letters, no digits, no symbols. 8 seconds, 16:9.',
};

// Second, higher-energy variant clips (approved 2026-08-27). Saved as
// {slug}-2.mp4; the manifest groups them with the original clip and the
// app picks randomly between them at play time. Narration lines match
// src/lib/animal-info.ts exactly, same as the originals.
const APPROVED_VARIANT_PROMPTS: Record<string, string> = {
  Shark:
    'Dynamic tracking shot swimming alongside a friendly sleek shark as it glides fast through a bright sunny coral reef, a sparkling school of tiny silver fish bursting apart around it, sunbeams dancing through clear turquoise water and playful bubble trails. Smooth energetic underwater camera, 35mm lens, bright clear light. Photorealistic ocean documentary for young children, vibrant and clean, single clear subject, exciting but friendly not scary. Audio: a warm friendly female narrator says cheerfully, "Sharks have sharp teeth!" — no background music, natural bubbly water sounds only. Mood: thrilling, joyful, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Whale:
    'Epic slow-motion wide shot of a giant humpback whale launching out of the sparkling blue ocean in a full breach, an enormous glittering splash crashing down with a soft rainbow shimmering in the spray and seabirds wheeling in the bright sky. Sweeping cinematic camera, 35mm lens, golden sunny light. Photorealistic ocean documentary for young children, vibrant and clean, single clear subject, awe-inspiring and friendly. Audio: a warm friendly female narrator says cheerfully, "Whales are huge!" — no background music, natural ocean splash sounds only. Mood: amazed, joyful, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Dolphin:
    'Exciting side tracking shot of a playful pod of three dolphins racing beside a gentle rolling wave, leaping one after another in graceful sparkling arcs against a golden sunset sky, splash trails glittering in the warm light. Fast smooth tracking camera, 35mm lens, warm glowing light. Photorealistic ocean documentary for young children, vibrant and clean, clear subjects, exciting and friendly. Audio: a warm friendly female narrator says cheerfully, "Dolphins jump and splash!" — no background music, natural splashing water sounds only. Mood: thrilling, joyful, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
};
...
function collectTargets(only: string[]): Target[] {
  ...
  for (const [word, prompt] of Object.entries(APPROVED_VARIANT_PROMPTS)) {
    const key = word.toLowerCase();
    if (wanted.size && !wanted.has(key) && !wanted.has(`${key}-2`)) continue;
    out.push({ word, slug: `${fileSlug(word)}-2`, prompt });
  }
  return out;
}
...
async function writeManifest() {
  ...
  // Variant files ({slug}-2.mp4 …) group with the base word; the app
  // picks randomly among a word's clips at play time.
  const urlsByWord = new Map<string, string[]>();
  for (const f of files.sort()) {
    const slug = f.replace(/\.mp4$/, "");
    const word = bySlug.get(slug) ?? bySlug.get(slug.replace(/-\d+$/, ""));
    if (!word) continue;
    const list = urlsByWord.get(word) ?? [];
    list.push(`/assets/videos/${f}`);
    urlsByWord.set(word, list);
  }
  const entries = [...urlsByWord.entries()].map(([word, urls]) =>
    `  ${JSON.stringify(word)}: ${JSON.stringify(urls.length === 1 ? urls[0] : urls)},`
  );
  const body = `/**
 ...
 * clip(s) under /public/assets/videos/. An array means multiple
 * variants — the app picks one at random per play.
 */
