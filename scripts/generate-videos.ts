...
const APPROVED_PROMPTS: Record<string, string> = {
  ...
  Eagle:
    'Wide-to-medium shot of a friendly eagle soaring smoothly across a bright blue sky above green mountains, wings spread clearly. Slow tracking camera, 50mm lens, sunny soft daylight. Photorealistic wildlife documentary for young children, vibrant and clean, single clear subject, majestic not scary. Audio: a warm friendly female narrator says cheerfully, "Eagles soar in the sky!" — no background music, natural gentle wind ambience only. Mood: happy, calm, wholesome. No on-screen text, no captions, no people. 8 seconds, 16:9.',
  Elephant:
